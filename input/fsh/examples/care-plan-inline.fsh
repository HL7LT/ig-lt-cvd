...
* activity[1].progress[0].text = "Dietary recommendations: fruits and vegetables >200 g/day, 35–45 g of fiber (mainly from grains), moderate unsalted nuts (30 g/day), fish 1–2 servings per week (one fatty), limited lean meat, low-fat dairy, and vegetable oils. Saturated fats <10% of total fat intake (replace with polyunsaturated fats), trans fats <1% of total energy (avoid processed foods). Salt <5–6 g/day. Alcohol <100 g per week (<15 g/day). Avoid sugary soft drinks and high-energy foods."
